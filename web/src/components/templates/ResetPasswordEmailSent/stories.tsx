...
import { ResetPasswordEmailSent } from '.';
...
storiesOf('Template - ResetPasswordEmailSent', module)
  .addParameters({
    viewport: {
  ...
  .add('Default ResetPasswordEmailSent Template', () => (
    <Container>
      <TopNavBar
        homeLink=""
        links={{
      ...
      />
      <ResetPasswordEmailSent isLoggedIn={boolean('Is Logged In', true)} />
      <ContactInfoBanner
